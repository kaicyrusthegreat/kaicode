...
def _resolve_mantle_config(
    *,
    ...
    if base_url is None:
        ...
        base_url = f"https://bedrock-mantle.{resolved_region}.api.aws/openai"
...
class OpenAIBedrockMantle(BaseMantleClient[httpx.Client, Stream[Any]], SyncAPIClient):
    messages: Messages
    beta: MantleBeta
...
class AsyncOpenAIBedrockMantle(BaseMantleClient[httpx.AsyncClient, AsyncStream[Any]], AsyncAPIClient):
