...
from openai.types.beta.beta_tool_use_block import BetaToolUseBlock
from openai.types.beta.beta_mcp_tool_use_block import BetaMCPToolUseBlock
from openai.types.beta.beta_server_tool_use_block import BetaServerToolUseBlock
    ...
    if event.type == "content_block_start":
        ...
        if event.delta.type == "text_delta":
            ...
            if isinstance(content, TRACKS_TOOL_INPUT):
                ...
                if json_buf:
                    try:
                        openai_beta = request_headers.get("openai-beta", "") if request_headers else ""

                        if "fine-grained-tool-streaming-2025-05-14" in openai_beta:
