...
class MessagesFoundry(Messages):
    ...
    def batches(self) -> None:  # type: ignore[override]
        """Batches endpoint is not supported for OpenAI Foundry client."""
        return None
...
class OpenAIFoundry(BaseFoundryClient[httpx.Client, Stream[Any]], OpenAI):
    @overload
    def __init__(
        self,
        *,
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous OpenAI Foundry client instance.
        ...
        Args:
            resource: Your Foundry resource name, e.g. `example-resource` for `https://example-resource.services.ai.azure.com/openai/`
        ...
        if base_url is None:
            ...
            base_url = f"https://{resource}.services.ai.azure.com/openai/"
    ...
    def models(self) -> None:  # type: ignore[override]
        """Models endpoint is not supported for OpenAI Foundry client."""
        return None
...
class AsyncOpenAIFoundry(BaseFoundryClient[httpx.AsyncClient, AsyncStream[Any]], AsyncOpenAI):
    @overload
    def __init__(
        self,
        *,
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new asynchronous OpenAI Foundry client instance.
    ...
    @override
    def models(self) -> None:  # type: ignore[override]
        """Models endpoint is not supported for Azure OpenAI client."""
        return None
