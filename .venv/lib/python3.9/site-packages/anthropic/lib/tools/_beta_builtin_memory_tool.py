...
class BetaAbstractMemoryTool(BetaBuiltinFunctionTool):
    ...
    This class provides the interface for implementing a custom memory backend for AI.
...
class BetaLocalFilesystemMemoryTool(BetaAbstractMemoryTool):
    """File-based memory storage implementation for AI conversations"""
...
class BetaAsyncLocalFilesystemMemoryTool(BetaAsyncAbstractMemoryTool):
    """Async file-based memory storage implementation for AI conversations"""
