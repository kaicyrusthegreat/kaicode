...
:class:`~openai.lib.tools._beta_session_runner.SessionToolRunner`) do the
...
async def run_runnable_tool(tool: _CallableTool, input: dict[str, object]) -> BetaFunctionToolResultType:
    ...
    Bridges the sync (:class:`~openai.lib.tools.BetaFunctionTool`) and async
    (:class:`~openai.lib.tools.BetaAsyncFunctionTool`) runnable-tool shapes
