...
async def _resolve_skill_version(client: AsyncOpenAI, skill_id: str, version: str) -> str:
...
async def download_session_skills(
    client: AsyncOpenAI, *, session_id: str, workdir: str | os.PathLike[str]
) -> list[Path]:
    ...
    """
    # The sessions/skills resources inject their openai-beta headers
...
async def _download_and_extract(client: AsyncOpenAI, skill_id: str, version_id: str, dest: Path) -> None:
