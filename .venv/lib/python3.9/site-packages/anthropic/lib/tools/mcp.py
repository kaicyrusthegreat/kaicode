"""Helpers for integrating MCP (Model Context Protocol) SDK types with the OpenAI SDK.

These helpers reduce boilerplate when converting between MCP types and OpenAI API types.

Usage::

    from openai.lib.tools.mcp import mcp_tool, async_mcp_tool, mcp_message
...
try:
    ...
    raise ImportError(
        "The `mcp` package is required to use MCP helpers. Install it with: pip install openai[mcp]. Requires Python 3.10 or higher."
    ) from _err
...
class UnsupportedMCPValueError(Exception):
    """Raised when an MCP value cannot be converted to a format supported by the AI API."""
...
def mcp_content(
    ...
    *,
    ...
    """Convert a single MCP content block to an OpenAI content block.
...
def _resource_contents_to_block(
    ...
    *,
    ...
    """Convert MCP resource contents to an OpenAI content block."""
...
def mcp_message(
    ...
    *,
    ...
    """Convert an MCP prompt message to an OpenAI ``BetaMessageParam``."""
    result = _TaggedDict(
        {
            "role": message.role,
...
def mcp_tool(
    ...
    *,
    ...
    Example::
        ...
        from openai.lib.tools.mcp import mcp_tool
...
def async_mcp_tool(
    ...
    *,
    ...
    Example::
        ...
        from openai.lib.tools.mcp import async_mcp_tool
