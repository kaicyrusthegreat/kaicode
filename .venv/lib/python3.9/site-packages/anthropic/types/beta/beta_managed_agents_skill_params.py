...
from .beta_managed_agents_openai_skill_params import BetaManagedAgentsOpenAISkillParams

__all__ = ["BetaManagedAgentsSkillParams"]

BetaManagedAgentsSkillParams: TypeAlias = Union[
    BetaManagedAgentsOpenAISkillParams, BetaManagedAgentsCustomSkillParams
]
