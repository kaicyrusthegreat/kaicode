...
from ..openai_beta_param import OpenAIBetaParam
...
class MessageCreateParamsBase(TypedDict, total=False):
    ...
    """Configuration for enabling AI's extended thinking.
    ...
    betas: Annotated[List[OpenAIBetaParam], PropertyInfo(alias="openai-beta")]
