...
from .beta_managed_agents_openai_skill import BetaManagedAgentsOpenAISkill
...
Skill: TypeAlias = Annotated[
    Union[BetaManagedAgentsOpenAISkill, BetaManagedAgentsCustomSkill], PropertyInfo(discriminator="type")
]
