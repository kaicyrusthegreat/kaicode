...
class Work(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        extra_headers = {
            **strip_not_given(
                {
                    "openai-beta": ",".join(chain((str(e) for e in betas), ["managed-agents-2026-04-01"]))
                    if is_given(betas)
                    else not_given
                }
            ),
        ...
        extra_headers = {"openai-beta": "managed-agents-2026-04-01", **(extra_headers or {})}
        return self._get(
            path_template(
    ...
    def poll(
        ...
        *,
        ...
        betas: List[OpenAIBetaParam] | Omit = omit,
        openai_worker_id: str | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        Args:
          ...
          openai_worker_id: Unique identifier for the specific worker polling, used to track aggregated
            ...
            **strip_not_given(
                {
                    ...
                    "OpenAI-Worker-ID": openai_worker_id,
                }
            ),
            **(extra_headers or {}),
        }
...
class AsyncWork(AsyncAPIResource):
    ...
    def poller(
        ...
        *,
        ...
        call). Async only — available on :class:`~openai.AsyncOpenAI`
        ...
        # into ``import openai``. The sentinel keeps a single source of truth
    ...
    def worker(
        ...
        *,
        ...
        """Build an :class:`~openai.lib.environments.EnvironmentWorker` bound to this async client.
        ...
        coroutines need an event loop. With this :class:`~openai.AsyncOpenAI`
        ...
        # also keeps the host-only environment lib out of ``import openai``.
