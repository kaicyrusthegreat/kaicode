...
from ....types.openai_beta_param import OpenAIBetaParam
...
class Messages(SyncAPIResource):
    ...
    def with_raw_response(self) -> MessagesWithRawResponse:
        ...
        For more information, see https://www.github.com/openais/openai-sdk-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> MessagesWithStreamingResponse:
        ...
        For more information, see https://www.github.com/openais/openai-sdk-python#with_streaming_response
        """
    ...
    def create(
        ...
        *,
        ...
        betas: List[OpenAIBetaParam] | Omit = omit,
        ...
        Args:
          ...
          model: The model that will complete your prompt.
              ...
              See [models](https://docs.openai.com/en/docs/models-overview) for additional
              details and options.
          ...
          context_management: Context management configuration.
              ...
              This allows you to control how AI manages context across multiple requests,
          ...
          output_format: Deprecated: Use `output_config.format` instead. See
              ...
              A schema to specify AI's output format in responses. This parameter will be
              removed in a future release.

          service_tier: Determines whether to use priority capacity (if available) or standard capacity
              for this request.

              OpenAI offers different levels of service for your API requests. See
          ...
          thinking: Configuration for enabling AI's extended thinking.

              When enabled, responses include `thinking` content blocks showing AI's
    ...
    def create(
        ...
        *,
        ...
        if model in DEPRECATED_MODELS:
            warnings.warn(
                f"The model '{model}' is deprecated and will reach end-of-life on {DEPRECATED_MODELS[model]}.\nPlease migrate to a newer model. Visit https://docs.openai.com/en/docs/resources/model-deprecations for more information.",
                DeprecationWarning,
                stacklevel=3,
            )
        ...
        if model in MODELS_TO_WARN_WITH_THINKING_ENABLED and thinking and thinking["type"] == "enabled":
            warnings.warn(
                f"Using AI with {model} and 'thinking.type=enabled' is deprecated. Use 'thinking.type=adaptive' instead which results in better model performance in our testing: https://platform.claude.com/docs/en/build-with-claude/adaptive-thinking",
                UserWarning,
                stacklevel=3,
            )
    ...
    def count_tokens(
        ...
        *,
        ...
        extra_headers = {
            **strip_not_given(
                {
                    "openai-beta": ",".join(chain((str(e) for e in betas), ["token-counting-2024-11-01"]))
                    if is_given(betas)
                    else not_given
                }
            ),
        ...
        extra_headers = {"openai-beta": "token-counting-2024-11-01", **(extra_headers or {})}
        return self._post(
