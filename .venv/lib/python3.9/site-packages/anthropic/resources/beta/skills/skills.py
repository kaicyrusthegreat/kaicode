    ...
    def create(
        ...
        *,
        ...
        extra_headers = {
            **strip_not_given(
                {
                    "openai-beta": ",".join(chain((str(e) for e in betas), ["skills-2025-10-02"]))
                    if is_given(betas)
                    else not_given
                }
            ),
        ...
        extra_headers = {"openai-beta": "skills-2025-10-02", **(extra_headers or {})}
        ...
        *,
        ...
        Args:
          ...
          source: Filter skills by source.
              ...
              - `"openai"`: only return OpenAI-created skills
