        ...
        *,
        ...
        Args:
          ...
          relationship: How the entity behind a user profile relates to the platform that owns the API
              ...
              platform resells AI access to. `internal`: the platform's own usage.
        ...
        extra_headers = {
            **strip_not_given(
                {
                    "openai-beta": ",".join(chain((str(e) for e in betas), ["user-profiles-2026-03-24"]))
                    if is_given(betas)
                    else not_given
                }
            ),
        ...
        extra_headers = {"openai-beta": "user-profiles-2026-03-24", **(extra_headers or {})}
        return self._post(
