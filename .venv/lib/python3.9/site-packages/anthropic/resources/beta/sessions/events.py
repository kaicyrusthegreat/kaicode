...
class AsyncEvents(AsyncAPIResource):
    ...
    def tool_runner(
        ...
        *,
        ...
        returns a :class:`~openai.lib.environments.SessionToolRunner` — an
        ...
        yields one :class:`~openai.lib.environments.DispatchedToolCall` per
        ...
        wrap it in an :class:`~openai.lib.environments.EnvironmentWorker` if
        you need heartbeating / force-stop.

        Usage::

            from openai.lib.tools.agent_toolset import AgentToolContext, beta_agent_toolset_20260401
        ...
        Args:
          ...
          tools: Registry of tool callables the runner will execute when the
            ...
            events — the same :class:`~openai.lib.tools.BetaAsyncFunctionTool`
