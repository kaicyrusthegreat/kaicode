...
_MODEL_LABELS = {
    ...
    # Ollama (local)
    "llama3.2":                   "Best for quick chat and simple tasks — fast, 2 GB",
    "llama3.2:latest":            "Best for quick chat and simple tasks — fast, 2 GB",
    "llama3.1":                   "Best for coding and longer reasoning — capable, 4.9 GB",
    "llama3.1:8b":                "Best for coding and longer reasoning — capable, 4.9 GB",
    "deepseek-r1:8b":             "Best for step-by-step reasoning, math, and logic — 5.2 GB",
    "deepseek-r1:latest":         "Best for step-by-step reasoning, math, and logic",
    "gemma4:latest":              "Best for general tasks — Google's latest model, 9.6 GB",
    "gemma4":                     "Best for general tasks — Google's latest model, 9.6 GB",
    "gpt-oss:20b":                "Best for complex coding and reasoning — large local model, 13 GB",
    "qwen2.5-coder:7b":           "Best for code generation and completion — code-specialized, 4.7 GB",
    "qwen2.5-coder":              "Best for code generation and completion — code-specialized",
    "qwen2.5-coder:latest":       "Best for code generation and completion — code-specialized",
    "qwen3-coder:latest":         "Best for advanced coding tasks — Qwen3 code model, 18 GB",
    "qwen3-coder":                "Best for advanced coding tasks — Qwen3 code model, 18 GB",
    "devstral:latest":            "Best for agentic coding, tool use, and complex tasks — 14 GB",
    "devstral":                   "Best for agentic coding, tool use, and complex tasks — 14 GB",
    "mistral-nemo":               "Best for multilingual tasks and general use — runs locally",
    "mistral-nemo:latest":        "Best for multilingual tasks and general use — runs locally",
