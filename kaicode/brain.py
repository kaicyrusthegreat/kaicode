...
def build_project_brain(cwd: str) -> None:
    ...
    root = Path(cwd)
    ignore_dirs = {".git", "__pycache__", "venv", "env", "node_modules", ".pytest_cache", "build", "dist"}
    ...
    print_success(f"Project Brain generated: {symbol_count} symbols across {file_count} Python files.")
